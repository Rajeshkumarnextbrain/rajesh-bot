...
#         self.default_model = ChatOpenAI(model=self.primary_model_name, temperature=self.temperature, max_retries=5)
#         self.high_capacity_model = ChatOpenAI(model=self.secondary_model_name, temperature=self.temperature, max_retries=5)
